(function(root,factory){
  ...
  const ERA_DEFS={
    ...
    5:{id:5,key:'stellar-forge',name:'STELLAR FORGE',site:'Helios Crown',theme:'stellar',duration:210,focus:'Energy capture and thermal stability',directive:'HARNESS A STAR',targets:[350,700,1050,1400],stageBias:{power:0.62,process:0.82},rewardPatents:1},
    6:{id:6,key:'law-foundry',name:'LAW FOUNDRY',site:'Causality Lattice',theme:'law',duration:225,focus:'Interdependent physical constants',directive:'FABRICATE STABLE LAW',targets:[900,1800,2700,3600],stageBias:{process:0.74,assembly:0.78,power:0.82},rewardPatents:1},
    7:{id:7,key:'universe-foundry',name:'UNIVERSE FOUNDRY',site:'Genesis Frame',theme:'universe',duration:240,focus:'Final integration and universe ignition',directive:'IGNITE A NEW UNIVERSE',targets:[2425,4850,7275,9700],stageBias:{source:0.84,process:0.80,transfer:0.82,assembly:0.76,power:0.78},rewardPatents:1}
  };
  const STAGE_DEFS={
